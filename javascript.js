...
{
    selectedColor = color;
    if(activePalletNode != null)
        activePalletNode.style.boxShadow = '';

    activePalletNode = node;
    activePalletNode.style.boxShadow ='0 0 8px inset rgb(0, 217, 255)';
}